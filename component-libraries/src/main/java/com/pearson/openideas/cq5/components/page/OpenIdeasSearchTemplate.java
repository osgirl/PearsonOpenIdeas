/**
 * Created: June 12, 2013 4:03:00 PM
 *
 ...
 * @author Sam Labib
 */
public class OpenIdeasSearchTemplate extends OpenIdeasMasterTemplate {
     ...
     *            The page context
     */
    public OpenIdeasSearchTemplate(PageContext pageContext) {
        super(pageContext);
    }
}