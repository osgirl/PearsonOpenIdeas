  ...
  jQuery.event.special.clickout = {
    ...
    add: function(handleObj){
      ...
      $(this).on(click + '.clickout' + counter, handleObj.selector, function(e){
        var clickin = $(this).attr('data-clickout');
        $(e.target).data("clickin", clickin);
      });
      ...
      // A closure is used create a static id
        return function(e){
          ...
          var clickin_id = $(e.target).data("clickin");
            clickin_id = parseInt(clickin_id);
          if (!clickin_id || clickin_id !== id) {
