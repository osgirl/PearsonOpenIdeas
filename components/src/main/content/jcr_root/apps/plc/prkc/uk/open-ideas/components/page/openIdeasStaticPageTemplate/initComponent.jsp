...
--%><%@page session="false"
            ...
            import="com.pearson.openideas.cq5.components.page.OpenIdeasStaticPageTemplate" %><%
%><%@taglib prefix="cq" uri="http://www.day.com/taglibs/cq/1.0" %><%
%><cq:defineObjects/>
<%
	OpenIdeasStaticPageTemplate template = new OpenIdeasStaticPageTemplate(pageContext);
