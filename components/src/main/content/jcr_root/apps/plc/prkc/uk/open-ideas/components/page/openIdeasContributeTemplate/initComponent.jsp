...
--%><%@page session="false"
            ...
            import="com.pearson.openideas.cq5.components.page.OpenIdeasContributeTemplate" %><%
%><%@taglib prefix="cq" uri="http://www.day.com/taglibs/cq/1.0" %><%
%><cq:defineObjects/>
<%
	OpenIdeasContributeTemplate template = new OpenIdeasContributeTemplate(pageContext);
